...
var zhStrings = map[string]string{
	...
	// ── Auth Files ──
	"auth_title":                "🔑 认证文件",
	"auth_help1":                " [↑↓/jk] 导航 • [Enter] 展开 • [e] 启用/停用 • [d] 删除 • [t] 测试模型 • [r] 刷新",
	...
	"status_active":             "活跃",
	"status_disabled":           "已停用",
	"test_model_ok":             "模型测试成功 (%s via %s)",
	"test_model_failed":         "模型测试失败",
	"test_model_missing_model":  "请输入模型名称",
	"test_model_missing_prompt": "请输入测试提示词",
...
var enStrings = map[string]string{
	...
	"auth_help1":                " [↑↓/jk] Navigate • [Enter] Expand • [e] Enable/Disable • [d] Delete • [t] Test Model • [r] Refresh",
	...
	"test_model_ok":             "Model test ok (%s via %s)",
	"test_model_failed":         "Model test failed",
	"test_model_missing_model":  "model is required",
	"test_model_missing_prompt": "prompt is required",
